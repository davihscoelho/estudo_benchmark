...
from src.data.get_data2 import get_anual_returns_cdi,get_anual_returns_indices_ihfa,get_anual_returns_indices_imab,get_anual_returns_indices_imab5,get_anual_returns_portfolios,get_anual_returns_indices
